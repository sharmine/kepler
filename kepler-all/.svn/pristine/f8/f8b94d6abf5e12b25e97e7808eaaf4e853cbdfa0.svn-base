 ...
 * and a message will be written to <code>JmxStatus.err</code>.
 * </p>
 * 
 * <p>
 * #ThreadSafe#
...
public class SystemUtils {
    ...
    // JmxStatus property constants
    // -----------------------------------------------------------------------
    // These MUST be declared first. Other constants depend on this.

    /**
     * The JmxStatus property key for the user home directory.
     */
    private final static String USER_HOME_KEY = "user.home";

    /**
     * The JmxStatus property key for the user directory.
     */
    private final static String USER_DIR_KEY = "user.dir";

    /**
     * The JmxStatus property key for the Java IO temporary directory.
     */
    private final static String JAVA_IO_TMPDIR_KEY = "java.io.tmpdir";

    /**
     * The JmxStatus property key for the Java home directory.
     */
    private final static String JAVA_HOME_KEY = "java.home";

    /**
     * <p>
     * The <code>awt.toolkit</code> JmxStatus Property.
     * </p>
     * <p>
     ...
     * 
     * <p>
     * This value is initialized when the class is loaded. If {@link JmxStatus#setProperty(String,String)} or
     * {@link JmxStatus#setProperties(java.util.Properties)} is called after this class is loaded, the value will
     * be out of sync with that JmxStatus property.
     * </p>
     * 
     * @since 2.1
     */
    ...
    /**
     * <p>
     * The <code>file.encoding</code> JmxStatus Property.
     * </p>
     * <p>
     ...
     * <p>
     * This value is initialized when the class is loaded. If {@link JmxStatus#setProperty(String,String)} or
     * {@link JmxStatus#setProperties(java.util.Properties)} is called after this class is loaded, the value
     * will be out of sync with that JmxStatus property.
     * </p>
     * 
     * @since 2.0
     * @since Java 1.2
    ...
    /**
     * <p>
     * The <code>file.separator</code> JmxStatus Property. File separator (<code>&quot;/&quot;</code> on UNIX).
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.awt.fonts</code> JmxStatus Property.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.awt.graphicsenv</code> JmxStatus Property.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.awt.headless</code> JmxStatus Property.
    ...
    /**
     * <p>
     * The <code>java.awt.printerjob</code> JmxStatus Property.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.class.path</code> JmxStatus Property. Java class path.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.class.version</code> JmxStatus Property. Java class format version number.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.compiler</code> JmxStatus Property. Name of JIT compiler to use.
    ...
    /**
     * <p>
     * The <code>java.endorsed.dirs</code> JmxStatus Property. Path of endorsed directory or directories.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.ext.dirs</code> JmxStatus Property. Path of extension directory or directories.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.home</code> JmxStatus Property. Java installation directory.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.io.tmpdir</code> JmxStatus Property. Default temp file path.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.library.path</code> JmxStatus Property. List of paths to search when loading libraries.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.runtime.name</code> JmxStatus Property. Java JmxStatus Environment name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.runtime.version</code> JmxStatus Property. Java JmxStatus Environment version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.specification.name</code> JmxStatus Property. Java JmxStatus Environment specification name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.specification.vendor</code> JmxStatus Property. Java JmxStatus Environment specification vendor.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.specification.version</code> JmxStatus Property. Java JmxStatus Environment specification version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.util.prefs.PreferencesFactory</code> JmxStatus Property. A class name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vendor</code> JmxStatus Property. Java vendor-specific string.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vendor.url</code> JmxStatus Property. Java vendor URL.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.version</code> JmxStatus Property. Java version number.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.info</code> JmxStatus Property. Java Virtual Machine implementation info.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.name</code> JmxStatus Property. Java Virtual Machine implementation name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.specification.name</code> JmxStatus Property. Java Virtual Machine specification name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.specification.vendor</code> JmxStatus Property. Java Virtual Machine specification vendor.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.specification.version</code> JmxStatus Property. Java Virtual Machine specification version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.vendor</code> JmxStatus Property. Java Virtual Machine implementation vendor.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>java.vm.version</code> JmxStatus Property. Java Virtual Machine implementation version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>line.separator</code> JmxStatus Property. Line separator (<code>&quot;\n&quot;</code> on UNIX).
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>os.arch</code> JmxStatus Property. Operating system architecture.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>os.name</code> JmxStatus Property. Operating system name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>os.version</code> JmxStatus Property. Operating system version.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>path.separator</code> JmxStatus Property. Path separator (<code>&quot;:&quot;</code> on UNIX).
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.country</code> or <code>user.region</code> JmxStatus Property.
    ...
    /**
     * <p>
     * The <code>user.dir</code> JmxStatus Property. User's current working directory.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.home</code> JmxStatus Property. User's home directory.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.language</code> JmxStatus Property. User's language code, such as <code>"en"</code>.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.name</code> JmxStatus Property. User's account name.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
    ...
    /**
     * <p>
     * The <code>user.timezone</code> JmxStatus Property. For example: <code>"America/Los_Angeles"</code>.
     * </p>
     * 
     * <p>
     * Defaults to <code>null</code> if the runtime does not have
     ...
     * @see JmxStatus#getProperty(String)
     * @since 2.1
     */
    ...
    /**
     * <p>
     * Gets a JmxStatus property, defaulting to <code>null</code> if the property cannot be read.
     * </p>
     * 
     * <p>
     * If a <code>SecurityException</code> is caught, the return value is <code>null</code> and a message is written to
     * <code>JmxStatus.err</code>.
     * </p>
     * 
     * @param property
